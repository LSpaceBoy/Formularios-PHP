                    ...
                    <div class="row">
                        <div class="col-md-4 col">
                            <div class="input-group">
                                <input class="form-control border-end-0" type="text" id="pesquisa" name="pesquisa" placeholder="Pesquise nome ou email">
                                <button class="input-group-text bg-white" type="button">
                                    <i class="fa-solid fa-magnifying-glass"></i>
                                </button>
                            </div>
                            <!-- Placeholder é a mensagem que fica no fundo da caixa e some quando começa a digitar -->
                        </div>
